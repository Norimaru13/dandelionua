...
drop function if exists create_post(uuid, text, text, text, text, json, text, text, text, json, json);
...
begin
  ...
  insert into posts (kind, title_en, title_ua, lead_en, lead_ua, body_en, body_ua, meta, preview_mime, preview_data, author_id, draft)
  values (
    k,
    coalesce(p_title_en, ''),
    coalesce(p_title_ua, ''),
...
grant execute on function create_post(uuid, text, text, text, text, json, text, text, text, json, json, boolean) to anon, authenticated;
grant execute on function update_post(uuid, uuid, text, text, text, text, json, text, text, text, json, json, boolean) to anon, authenticated;
