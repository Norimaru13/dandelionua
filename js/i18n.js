...
var translations = {
  en: {
    ...
    account_password_repeat: "repeat password",
    ...
    post_save: "save",
    post_draft: "not published",
    post_pending: "changes not applied",
    post_eye: "current look",
    post_eye_lock: "Turn off the eye to edit.",
    post_bold: "bold",
    post_italic: "italic",
  ...
  ua: {
    ...
    account_password_repeat: "повтори пароль",
    account_show_password: "показати пароль",
    ...
    account_edit_nick: "редагувати нік",
    ...
    err_password_match: "паролі не збігаються",
    ...
    post_save: "зберегти",
    post_draft: "не опубліковано",
    post_pending: "зміни не застосовано",
    post_eye: "як зараз",
    post_eye_lock: "Вимкни око, щоб редагувати.",
